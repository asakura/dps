...
///
/// assert_relative_eq!(d + GramsPerLitre::new(0.5), GramsPerLitre::new(1.688));
/// assert_relative_eq!(d - GramsPerLitre::new(0.5), GramsPerLitre::new(0.688));
/// assert_relative_eq!(d * 2.0, GramsPerLitre::new(2.376));
/// assert_relative_eq!(d / 2.0, GramsPerLitre::new(0.594));
///
...
/// assert_relative_eq!(f64::from(e), 1.188);
///
/// assert_relative_eq!(-d, GramsPerLitre::new(-1.188));
/// assert_relative_eq!(2.0_f64 * d, GramsPerLitre::new(2.376));
