...
///
/// assert_relative_eq!(rate + CnsRatePerMinute::new(100.0 / 150.0), CnsRatePerMinute::new(200.0 / 150.0));
/// assert_relative_eq!(rate * 150.0, CnsRatePerMinute::new(100.0));
/// assert_relative_eq!(rate / 2.0, CnsRatePerMinute::new(100.0 / 300.0));
///
