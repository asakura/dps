{
  description = "dps: Dive Planning System";
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in
      {
        ...
        // pkgs.lib.optionalAttrs (system == "x86_64-linux") {
          dps = mkMuslPackage pkgs.pkgsCross.musl64 "x86_64-unknown-linux-musl";
          dps-aarch64-linux-musl = mkMuslPackage pkgs.pkgsCross.aarch64-multiplatform-musl "aarch64-unknown-linux-musl";
        };
